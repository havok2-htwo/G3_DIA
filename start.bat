...
REM =================================================================
REM == Startskript fuer GENESIS DIA Server
REM == richtet bei Bedarf lokale virtuelle Umgebung .\venv selbst ein
REM =================================================================

cd /D "%~dp0"
chcp 65001 > nul
title G3 DIA Server Launcher
...
echo Starte den GENESIS DIA Server...
title G3 DIA Server
call "%VENV_PYTHON%" -m backend.genesis_dia_server

echo.
echo =================================================================
echo == Der GENESIS DIA Server wurde beendet.
