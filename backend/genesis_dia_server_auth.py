...
from .genesis_dia_password_hash import build_pbkdf2_hash, verify_pbkdf2_hash

# --- configuration ---
SESSION_COOKIE_NAME = "g3_dia_session"
...
class AuthStore:
    ...
    keys, all persisted to one JSON file (logs/genesis_dia_secrets.json)."""

    def __init__(self, project_root: Path):
        self.project_root = Path(project_root)
        self.logs_dir = self.project_root / "logs"
        self.secrets_path = self.logs_dir / "genesis_dia_secrets.json"
