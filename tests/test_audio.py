...
from backend import genesis_dia_server_audio as audio
...
class AudioDecoderTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.temp_dir = tempfile.TemporaryDirectory(prefix="genesis-dia-tests-")
    ...
    def test_tail_moov_m4a_decodes_from_seekable_tempfile(self) -> None:
    ...
    def test_invalid_container_error_uses_original_filename(self) -> None:
        ...
        self.assertNotIn("genesis-dia-input-", raised.exception.detail)
